		...
		Executors.newScheduledThreadPool(1).scheduleAtFixedRate(
				new Runnable(){
					public void run(){
						...
						System.out.println("The Common Customer number " + serviceNumber + " is waitting for service！");						
					}
				},
				0,
		...
		Executors.newScheduledThreadPool(1).scheduleAtFixedRate(
				new Runnable(){
					public void run(){
						...
						System.out.println("The Express Customer number " + serviceNumber + " is waitting for service！");
					}
				},
				0,
		...
		Executors.newScheduledThreadPool(1).scheduleAtFixedRate(
				new Runnable(){
					public void run(){
						...
						System.out.println("The VIP Customer number " + serviceNumber + " is waitting for service！");
					}
				},
				0,
